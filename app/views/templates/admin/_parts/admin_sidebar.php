    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item">
                    <a class="menu-link" href="<?= '/' . $this->session->userdata('user_guard') ?>">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="<?= '/' . $this->session->userdata('user_guard') . '/students' ?>">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="<?= '/' . $this->session->userdata('user_guard') . '/teachers' ?>">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="<?= '/' . $this->session->userdata('user_guard') . '/catalogs' ?>">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="<?= '/' . $this->session->userdata('user_guard') . '/reports' ?>">
                        <span class="menu-icon">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="<?= '/' . $this->session->userdata('user_guard') . '/careers' ?>">
                        <span class="menu-icon">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <a class="menu-link" href="<?= '/' . $this->session->userdata('user_guard') . '/custom' ?>">
                        <span class="menu-icon">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1">
                    <a class="menu-link" href="<?= '/' . $this->session->userdata('user_guard') . '/infosys' ?>">
                        <span class="menu-icon">
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                    <a class="menu-link" href="<?= '/' . $this->session->userdata('user_guard') . '/profile' ?>">
                    <span class="menu-icon">
