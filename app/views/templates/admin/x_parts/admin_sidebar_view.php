                    ...
                    <li class="dropdown notification-list dropdown d-none d-lg-inline-block ml-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="<?=base_url('assets/images/flags/germany.jpg')?>" alt="lang-image" class="mr-1" height="12"> <span
                                    class="align-middle">German</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="<?=base_url('assets/images/flags/italy.jpg')?>" alt="lang-image" class="mr-1" height="12"> <span
                                    class="align-middle">Italian</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="<?=base_url('assets/images/flags/spain.jpg')?>" alt="lang-image" class="mr-1" height="12"> <span
                                    class="align-middle">Spanish</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <img src="<?=base_url('assets/images/flags/russia.jpg')?>" alt="lang-image" class="mr-1" height="12"> <span
